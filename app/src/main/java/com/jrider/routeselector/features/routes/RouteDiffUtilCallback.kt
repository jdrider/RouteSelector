...
class RouteDiffUtilCallback(val oldRoutes: List<Route>, val newRoutes: List<Route>) : DiffUtil.Callback() {
    ...
    override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
        return oldRoutes[oldItemPosition].id == newRoutes[newItemPosition].id
    }
